...
pictureSideBarTemp.innerHTML = `
    ...
    <div id="picture_sidebar">
        ...
        <ul id="side_bar_list">
            <li class="side_bar_item"><a href="javascript:">地球</a></li> 
            <li class="side_bar_item"><a href="javascript:">水星</a></li> 
            <li class="side_bar_item"><a href="javascript:">金星</a></li> 
            <li class="side_bar_item"><a href="javascript:">火星</a></li> 
            <li class="side_bar_item"><a href="javascript:">木星</a></li> 
