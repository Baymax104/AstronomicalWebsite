...
(function () {
    ...
    // 将外部img标签添加到shadowRoot内
    // 获取外部img标签
    let carouselImage = document.getElementsByTagName("carousel-image")[0];
    let imgs = carouselImage.getElementsByTagName("img");

    // 操作shadowRoot
    let shadowRoot = carouselImage.shadowRoot;
    let imgContainer = shadowRoot.getElementById("carousel_img_container");
    ...
    let aContainer = shadowRoot.getElementById("carousel_nav");
